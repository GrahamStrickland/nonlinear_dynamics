...
In Figure~\ref{fig2_2_2vecfield}, we have a plot of the vector field,
fixed points,
...
\]
\begin{figure}[!ht]
  \includegraphics[scale=0.8, center]{../plots/ch02/fig2_2_2vecfield.pdf}
  \caption{Vector field and fixed points for $\dot{x} = 1 -
  x^{14}$\label{fig2_2_2vecfield}}
\end{figure}
