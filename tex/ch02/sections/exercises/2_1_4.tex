...
\begin{itemize}
  \item[(a)] We begin by evaluating
    \[
      t = \ln{\biggl\lvert\frac{\csc{x_0} + \cot{x_0}}{\csc{x} +
      \cot{x}}\biggr\rvert}
    \]
    with $x_0 = \pi / 4$ to find
    \begin{equation*}
      \begin{split}
        t &= \ln{\biggl\lvert\frac{\sqrt{2} + 1}{\csc{x} +
        \cot{x}}\biggr\rvert} \\
    ...
    \begin{equation*}
      \begin{split}
        ...
        \Leftrightarrow \frac{x}{2} &= \tan^{-1}{\biggl(\frac{e^t}{1
        + \sqrt{2}}\biggr)} \\
  ...
  \item[(b)] An analytic solution is given by performing the steps in
    (a) without
