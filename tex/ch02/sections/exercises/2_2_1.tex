...
In Figure~\ref{fig2_2_1vecfield}, we have a plot of the vector field,
fixed points,
...
\begin{figure}[!ht]
  ...
  \caption{Vector field and fixed points for $\dot{x} = 4x^2 -
  16$\label{fig2_2_1vecfield}}
\end{figure}

An explicit solution for $\dot{x} = 4x^2 - 16$ can be found by
...
\]
and integrate either sides with respect to the $x$ and $t$,
...
After replacing $\pm e^{c_2}$ by $c$ and solving the last equation
for $x$, we have
